...
# -------- 下载 Geoview 最新版 --------
echo "Downloading geoview binary..."
BIN_DIR="$GITHUB_WORKSPACE/openwrt/files/usr/bin"
mkdir -p "$BIN_DIR"
curl -L -o "$BIN_DIR/geoview" \
  "https://github.com/snowie2000/geoview/releases/download/v0.2.5/geoview-linux-arm64"
chmod +x "$BIN_DIR/geoview"
